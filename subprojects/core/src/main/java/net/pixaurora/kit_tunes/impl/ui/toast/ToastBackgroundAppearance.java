...
public class ToastBackgroundAppearance {
	...
	public List<List<ToastBackgroundTile>> initColumns() {
		...
		return Arrays.asList(
			Arrays.asList(
				new ToastBackgroundTile(first, this.topLeftSize()),
			...
			Arrays.asList(
				new ToastBackgroundTile(middle.withYOf(first), this.topMiddleSize()),
				new ToastBackgroundTile(middle, this.centerSize()),
				new ToastBackgroundTile(middle.withYOf(last), this.bottomMiddleSize())
			),
			Arrays.asList(
				new ToastBackgroundTile(last.withYOf(first), this.topRightSize()),
