...
public class MeowPlayingToast implements KitTunesToastData {
	...
	public static final NamespacedResourcePath DEFAULT_ICON = KitTunes.resource("textures/album_art/default.png");

	public static final NamespacedResourcePath BG_TOP = KitTunes.resource("textures/gui/toast/loaf_top.png");
	public static final NamespacedResourcePath BG_MID = KitTunes.resource("textures/gui/toast/loaf_middle.png");
	public static final NamespacedResourcePath BG_BOT = KitTunes.resource("textures/gui/toast/loaf_bottom.png");
