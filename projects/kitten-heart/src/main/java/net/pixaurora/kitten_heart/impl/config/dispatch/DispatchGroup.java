...
public class DispatchGroup<A extends SpecifiesType<A>, T extends DispatchType<A>> {
    ...
    public <G> T lookupBy(String lookupType, Function<T, G> getter, G lookupObject) {
        ...
        try {
            ...
            throw new JsonParseException(this.typeName + " lookup did not find a type with " + lookupType + "  = `"
    ...
    public static final class Serializer<A extends SpecifiesType<A>, T extends DispatchType<A>>
            implements DualSerializer<A> {
        ...
        @Override
        public A deserialize(JsonElement element, Type _type, JsonDeserializationContext context)
